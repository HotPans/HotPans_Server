...
import hotpans.service.BreadService;
...
//    }
    ...
    public Bread postBread(
            ...
            @RequestParam("bakeryId") Integer bakeryId,
        ...
        bread.setIntroduction(introduction);
        bread.setBakeryId(bakeryId);
